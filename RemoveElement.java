...
public final class RemoveElement extends UDF {
  public String evaluate(String list, String removeString) throws HiveException { String[] splits = list.split(","); //System.out.println(list + " : " + splits.length + " " + removeString);
